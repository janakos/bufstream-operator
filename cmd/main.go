...
import (
	...
	"github.com/janakos/bufstream-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(bufstreamv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "fff71bb6.buf.build",
	...
	if err := (&controller.ACLReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
